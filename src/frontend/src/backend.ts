...
import type { StudentSignup as _StudentSignup, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllSignups(): Promise<Array<StudentSignup>> {
        if (this.processError) {
            try {
    ...
    async getMySignups(): Promise<Array<StudentSignup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMySignups();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSignupById(arg0: bigint): Promise<StudentSignup | null> {
        if (this.processError) {
            try {
    ...
    async signup(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudentSignup]): StudentSignup | null {
    return value.length === 0 ? null : value[0];
}
